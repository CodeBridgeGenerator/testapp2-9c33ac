...
import SingleMemoPage from "../components/MemoPage/SingleMemoPage";
import MemoProjectLayoutPage from "../components/MemoPage/MemoProjectLayoutPage";
import SingleSeksyenPage from "../components/SeksyenPage/SingleSeksyenPage";
import SeksyenProjectLayoutPage from "../components/SeksyenPage/SeksyenProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/memo/:singleMemoId" exact element={<SingleMemoPage />} />
<Route path="/memo" exact element={<MemoProjectLayoutPage />} />
<Route path="/seksyen/:singleSeksyenId" exact element={<SingleSeksyenPage />} />
<Route path="/seksyen" exact element={<SeksyenProjectLayoutPage />} />
