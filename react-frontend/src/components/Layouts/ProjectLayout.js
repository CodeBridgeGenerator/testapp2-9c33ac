...
import SeksyenPage from "../SeksyenPage/SeksyenPage";
// ~cb-add-import~
...
<li
                ...
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "users",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "users" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  ...
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "users",
                      "text-yellow-700": props?.currentActiveTab2 !== "users",
                    })}
                  >
...
<li
                onClick={() => {
                  setCurrentActiveTab2("memo");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "memo",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "memo" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "memo",
                      "text-black": props?.currentActiveTab2 !== "memo",
                    })}
                  >
                  Memo
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "memo",
                      "text-yellow-700": props?.currentActiveTab2 !== "memo",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
...
<li
                onClick={() => {
                  setCurrentActiveTab2("seksyen");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "seksyen",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "seksyen" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "seksyen",
                      "text-black": props?.currentActiveTab2 !== "seksyen",
                    })}
                  >
                  Seksyen
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "seksyen",
                      "text-yellow-700": props?.currentActiveTab2 !== "seksyen",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
